        ...
        <form onSubmit={handleSubmit} className="glass-strong rounded-3xl p-8 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="mt-1 w-full bg-input/60 text-foreground rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-ring placeholder:text-muted-foreground resize-none"

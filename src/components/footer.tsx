    ...
    <footer className="mt-24 border-t border-border/50 glass">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/workouts" className="hover:text-foreground">Workouts</Link></li>
              <li><Link to="/nutrition" className="hover:text-foreground">Nutrition</Link></li>
              <li><Link to="/chatbot" className="hover:text-foreground">AI Coach</Link></li>
        ...
        <div className="mt-10 pt-6 border-t border-border/40 flex items-center justify-center gap-4 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} FitAI</p>
        </div>
      </div>
    </footer>
  );
